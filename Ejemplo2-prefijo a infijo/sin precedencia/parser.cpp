...
#line 146 "parser.cpp" /* yacc.c:355  */
};
...
#line 56 "parser.y" /* yacc.c:1646  */
    { std::cout<<(yyvsp[0].Concat)->Cadena<<"="<<(yyvsp[0].Concat)->MiValor<<std::endl; }
#line 1232 "parser.cpp" /* yacc.c:1646  */
    break;

  case 3:
#line 58 "parser.y" /* yacc.c:1646  */
    {(yyval.Concat)=new Operador(); (yyval.Concat)->Cadena=(yyvsp[-1].Concat)->Cadena+"+"+(yyvsp[0].Concat)->Cadena; (yyval.Concat)->MiValor=(yyvsp[-1].Concat)->MiValor+(yyvsp[0].Concat)->MiValor; }
...
#line 61 "parser.y" /* yacc.c:1646  */
    {(yyval.Concat)=new Operador(); (yyval.Concat)->Cadena=(yyvsp[0].TEXT); (yyval.Concat)->MiValor=atoi((yyvsp[0].TEXT)); }
