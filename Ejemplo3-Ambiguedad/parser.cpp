...
#line 57 "parser.y" /* yacc.c:1646  */
    {
		(yyval.Concat)= new Operador(); (yyval.Concat)->Cadena=(yyvsp[-2].Concat)->Cadena+"+"+(yyvsp[0].Concat)->Cadena; (yyval.Concat)->MiValor=(yyvsp[-2].Concat)->MiValor+(yyvsp[0].Concat)->MiValor;
	}
