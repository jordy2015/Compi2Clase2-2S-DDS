...
{
  "$end", "error", "$undefined", "mas", "menos", "por", "numero", "divi",
  "Id", "$accept", "S1", "S2", YY_NULLPTR
};
#endif
...
#line 58 "parser.y" /* yacc.c:1646  */
    { std::cout<<(yyvsp[0].Concat)->Cadena<<std::endl; }
...
#line 60 "parser.y" /* yacc.c:1646  */
    {
		(yyval.Concat)=new Operador(); (yyval.Concat)->Cadena=(yyvsp[-1].Concat)->Cadena+"+"+(yyvsp[0].Concat)->Cadena;  
		(yyval.Concat)->precedencia=1;
	}
...
#line 68 "parser.y" /* yacc.c:1646  */
    {
		if((yyvsp[-1].Concat)->precedencia==1)
			(yyvsp[-1].Concat)->Cadena="("+(yyvsp[-1].Concat)->Cadena+")";	
		if((yyvsp[0].Concat)->precedencia==1)
			(yyvsp[0].Concat)->Cadena="("+(yyvsp[0].Concat)->Cadena+")";	
		(yyval.Concat)=new Operador(); (yyval.Concat)->Cadena=(yyvsp[-1].Concat)->Cadena+"*"+(yyvsp[0].Concat)->Cadena; 
		(yyval.Concat)->precedencia=2;
	}
...
#line 76 "parser.y" /* yacc.c:1646  */
    {(yyval.Concat)=new Operador(); (yyval.Concat)->Cadena=(yyvsp[0].TEXT); (yyval.Concat)->precedencia=3;}
