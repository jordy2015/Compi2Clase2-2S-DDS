...
/* In a future release of Bison, this section will be replaced
   by #include "parser.h".  */
#ifndef YY_JJ_PARSER_H_INCLUDED
# define YY_JJ_PARSER_H_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
{
  "$end", "error", "$undefined", "cero", "uno", "$accept", "S1", "S2",
  "S3", YY_NULLPTR
};
#endif
...
#line 44 "parser.y" /* yacc.c:1646  */
    { std::cout<<"decimal:"<<(yyvsp[0].operador)<<std::endl;}
#line 1223 "parser.cpp" /* yacc.c:1646  */
    break;

  case 3:
#line 46 "parser.y" /* yacc.c:1646  */
    { (yyval.operador)=(yyvsp[-1].operador)*2+(yyvsp[0].operador);}
